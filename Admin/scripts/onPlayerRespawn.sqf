switch (playerSide) do
{
	case west: 
	{
		...
		["Blue Loadout, Success", "success"] call WS_fnc_notify;
	};
	case east: 
	{
		removeAllWeapons Player;
		...
		Player addPrimaryWeaponItem "JLTS_DC15A_mag";
		//Armor
		Player forceAddUniform "180th_Arena_R_Uniform";
		Player addVest "180th_Trooper_Vest";
		Player addBackpack "180th_clone_bags";
		//Additionals
		Player addMagazine "Laserbatteries";
		...
		for "_i" from 1 to 5 do {Player addItemToBackpack "ACE_tourniquet";};
		Player addItemToBackpack "JLTS_stun_mag_short";
		Player addHeadgear "180th_Arena_R_Helmet";
		//OtherShit
		Player linkItem "ItemMap";
		Player linkItem "ItemCompass";
		Player linkItem "ItemcTab";
		["Red Loadout, Success", "success"] call WS_fnc_notify;
	};
};